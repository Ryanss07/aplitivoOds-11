...
public class GerenciarUsuarios extends javax.swing.JFrame {
    ...
    public GerenciarUsuarios() {
     ...
     private void atualizarLabels() {
        nomelabel1.setText(tradutor.traduzir("nome") + ":");
        emaillabel1.setText(tradutor.traduzir("email") + ":");
        endlabel1.setText(tradutor.traduzir("endereco") + ":");
        mp_btn1.setText(tradutor.traduzir("modperm"));
        edt_btn1.setText(tradutor.traduzir("edituser"));
        exc_btn.setText(tradutor.traduzir("excluir"));
    }
    /**
    ...
    private void mp_btn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mp_btn1ActionPerformed
        Usuario usuarioLogado = UsuarioLogado.getUsuario();
            ...
            if (selectedRow != -1) {
             ...
             boolean sucesso = bancoDeDados.trocarTipoUsuario(email);
             carregarUsuarios();
            } else {
