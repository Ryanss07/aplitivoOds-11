...
public class TelaLogin extends javax.swing.JFrame {
    ...
    private void atualizarLabels() {
        ...
        lg_btn.setText(tradutor.traduzir("login"));
    ...
    private void lg_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_lg_btnActionPerformed
       ...
       String resultadoValidacao = bancoDeDados.validarLogin(email, senha);
           ...
           switch (resultadoValidacao) {
               case "sucesso":
                   JOptionPane.showMessageDialog(this, tradutor.traduzir("loginSucesso"));
               ...
               case "camposVazios":
                   JOptionPane.showMessageDialog(this, tradutor.traduzir("erro") + ": " + tradutor.traduzir("camposVazios"));
                   break;

               case "usuarioInexistente":
                   JOptionPane.showMessageDialog(this, tradutor.traduzir("erro") + ": " + tradutor.traduzir("usuarioInexistente"));
                   break;

               case "senhaIncorreta":
                   JOptionPane.showMessageDialog(this, tradutor.traduzir("erro") + ": " + tradutor.traduzir("senhaIncorreta"));
                   break;

               case "erroBanco":
                   JOptionPane.showMessageDialog(this, tradutor.traduzir("erro") + ": " + tradutor.traduzir("erroBanco"));
                   break;

               default:
                   JOptionPane.showMessageDialog(this, tradutor.traduzir("erro") + ": " + tradutor.traduzir("erroDesconhecido"));
                   break;
           }
